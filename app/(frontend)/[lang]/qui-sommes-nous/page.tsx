...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: absolute(links.quiSommesNous(lang as AppLocale)),
      languages: languageAlternates(routing.locales, (l) => links.quiSommesNous(l as AppLocale)),
    },
  }
}
