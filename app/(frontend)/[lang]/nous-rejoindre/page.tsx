...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: absolute(links.nousRejoindre(lang as AppLocale)),
      languages: languageAlternates(routing.locales, (l) => links.nousRejoindre(l as AppLocale)),
    },
  }
}
